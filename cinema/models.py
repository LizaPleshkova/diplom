...
class Hall(models.Model):
    ...
    name = models.CharField(max_length=100)
    id_cinema = models.ForeignKey(Cinema, models.DO_NOTHING)
...
class Seat(models.Model):
    ...
    id_hall = models.ForeignKey(Hall, models.DO_NOTHING)
    id_sector = models.ForeignKey(Sector, models.DO_NOTHING, blank=True, null=True)
...
class ScheduleRental(models.Model):
    '''  прокат фильма '''
    id_rental = models.AutoField(primary_key=True)
    id_movie = models.ForeignKey(Movie, models.DO_NOTHING, related_name='movie_rental')
